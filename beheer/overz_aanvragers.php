...
include_once('../classes/c_aanvrager_coll.php');
...
$personsColl = new Aanvrager_coll ($arr1);

global $connection;
openDB();


$html = '<table class="ta"><tr><th>ID</th><th>Naam</th><th>Email</th><th>Nieuwsbrief</th></tr>';
...
//   	echo $person;
		...
		<td>' . html_entity_decode($person->volnaam) . '</td><td>' . html_entity_decode($person->emailadres) . '</td>
		<td>' . $nb . '</td>
		</tr>';
	}
$html .= '</table>';	
